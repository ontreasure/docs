...
As sales come in, they will be paid out to the payout method you set in your Payouts page. The dollar amount that appears on each record in the Sales page is the amount you will receive from Treasure after service and transaction fees are collected. For information on the schedule of payouts, check out our [pricing page](https://www.ontreasure.com/pricing). For more information on payouts, you can read the *payouts guide* (coming soon).
