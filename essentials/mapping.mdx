...
<Note>
  If you are building a map template, the only way this process would differ is that after creating your template, you then must go into the event you are hoping to set the map live for and choose the template you just created when prompted to do so from the "Edit Venue Map" page.
</Note>
...
<Steps>
  ...
  <Step title="Update Your Settings">
    ...
    3. Set a border for your map that encompasses the entire venue map you've created with additional padding around your floor plan for better visibility on your event page
...
<iframe width="560" height="315" src="https://www.youtube.com/embed/zYaE7H0h9wk?si=j9SofKlMuK747jDI" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen />