...
<Steps>
  ...
  <Step title="Set the order of highlights">
    When you highlight multiple vendors, you are able to set the order that they appear on your live venue map. When your desired order is set, make sure to save the changes and publish your map to your event page to make it go live.
