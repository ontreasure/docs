...
1. Host
   ...
   * Hosts have all of the same permissions as the event creator (you) and will be able to add/remove members of the team as such

2. Co-Host

   * Co-Hosts have all permissions of a host, except they cannot delete an event. They will also appear on your event page
