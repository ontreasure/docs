...
description: "Customize your cart type, method of checkout, table limit, and fee structure for your vendors"
---

During the create event process you are able to set the type of cart and checkout method for your vendors, among other advanced settings. See the image below for accessing this setting.
