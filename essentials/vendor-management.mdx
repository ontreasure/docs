...
<Steps>
  ...
  <Step title="Track Vendors on Your Vendor Dashboard">
    Once your event is live and you start receiving vendor applications, you can keep track of them from your vendor dashboard. The dashboard provides an overview of the number of applications you've accepted/rejected and how much of each table tier you've sold
...
<iframe width="560" height="315" src="https://www.youtube.com/embed/c-XxJ-EopvM?si=JXz3Y5xUlr4vPzuS" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen />
