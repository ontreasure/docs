...
<Steps>
  ...
  <Step title="Track Vendors on Your Vendor Dashboard">
    Once your event is live and you start receiving vendor applications, you can keep track of them from your vendor dashboard. The dashboard provides an overview of the number of applications you've accepted/rejected and how much of each table tier you've sold. It also shows you a filterable table of all your vendor applications regardless of their status.
