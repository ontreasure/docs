---
title: "Quickstart"
description: "Treasure's powerful event management tools make it easy for you to quickly launch and promote your events. We provide a platform to manage all your vendors, build interactive maps to showcase them, and drive more ticket sales. "
---
...
<AccordionGroup>
  ...
  <Accordion title="Track vendor applications" icon="store">
    ...
    <Note>
      Note that with option 2, changes to prices of your tables after a vendor application is submitted will not impact the amount that vendor pays with auto-pay. Vendors will be charged the price that you had for your tables at the time of their application, regardless of any changes to the price made after they applied.
    </Note>
    <Check>
